...
earth.position.z = -5;
scene.add(earth);
const earthTexture2 = new THREE.TextureLoader().load("images/01-3.jpg");
...
function animate() {
  ...
  earth2.rotation.y += 0.005;
  earth2.rotation.x += 0.006;
  earth2.rotation.z += 0.006;
...
function handlerScroll() {
  ...
  if (camera.position.z < -2.4) {
    cube.rotation.y = 1;
    cube.rotation.x = 0;
    if (earth2.position.x > -0.1) {
      earth2.position.x -= 0.12;
    }
  } else {
    earth2.position.x = 0;
  }
